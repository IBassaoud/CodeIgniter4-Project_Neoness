<div class="flex justify-center md:px-32 py-8 w-4/5">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <div class="flex items-center">
                                        ...
                                        <span class="font-medium"><?= $user[0]['firstname'] . " " . $user[0]['lastname']; ?></span>
                                </div>    
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="font-medium"><?= $user[0]['email']?></span>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <span class="font-medium"><?= $user[0]['phone']?></span>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <span class="font-medium"><?= $user[0]['age']?></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="font-medium"><?= $user[0]['weight'] . " kg"?></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="font-medium"><?= $user[0]['height'] . " cm"?></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="font-medium"><?= $user[0]['weight_target']?></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="font-medium"><?= $user[0]['bmi']?></span>
                                </td>
                                <td class="py-3 px-6 text-center">
