...
<?php if (isset($validation)): 
    $allErrors = $validation->listErrors();
    $allErrors = str_replace('repeat_password', 'confirm password',$allErrors);
    $allErrors = str_replace('current_password', 'current password',$allErrors);
    ?>
...
<?php endif; ?>
  ...
  <button type="submit" class="text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
