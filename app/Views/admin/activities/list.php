                    ...
                    <table class="min-w-max w-3/5">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                <th class="py-2 text-center text-blue-500" colspan="9"><?= esc($titleActivities)?></th>
                            </tr>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-2 px-3 text-center">
                                    <div class="flex item-center justify-center">
                                        <a href=<?= base_url('dashboard/activities/'.$activity['id']);?> class="w-4 h-4 fill-current inline-block mr-2 transform hover:text-purple-500 hover:scale-110">
