...
function ageCount() {
    ...
    var dobget =document.getElementById("age").value; //getting user input
...
function calculateBMI(){
    ...
    let bmi = document.getElementById('bim');
    ...
    // If both input is valid, calculate the bmi
        ...
        if (userBIM < 18.6) bmi.value = userBIM;

        else if (userBIM >= 18.6 && userBIM < 24.9) 
        bmi.value = userBIM;

        else bmi.value = userBIM;
    }
}